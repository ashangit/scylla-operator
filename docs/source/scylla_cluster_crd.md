...
* `multiDcCluster`: Optional field. Allow to configure multi data center cluster. See [details](https://docs.scylladb.com/operating-scylla/procedures/cluster-management/create_cluster_multidc/).
